...
Route::prefix('layanan')->group(function () {
    ...
    Route::get('/pusat-rehabilitasi-stroke/terapi-robotik/lokomat-pro-sensation', [LayananController::class, 'lokomatProSensation'])->name('layanan.lokomat-pro-sensation');
    Route::get('/pusat-rehabilitasi-stroke/terapi-robotik/cmill-vr-plus', [LayananController::class, 'cmillVrPlus'])->name('layanan.cmill-vr-plus');
    Route::get('/pusat-rehabilitasi-stroke/terapi-robotik/andago', [LayananController::class, 'andago'])->name('layanan.andago');
    Route::get('/pusat-rehabilitasi-stroke/terapi-robotik/armeo-spring', [LayananController::class, 'armeoSpring'])->name('layanan.armeo-spring');
    Route::get('/pusat-rehabilitasi-stroke/terapi-robotik/arm-motus-m2', [LayananController::class, 'armMotusM2'])->name('layanan.arm-motus-m2');
    Route::get('/pusat-rehabilitasi-stroke/terapi-robotik/fourier-ecosystem', [LayananController::class, 'fourierEcosystem'])->name('layanan.fourier-ecosystem');
    Route::get('/pusat-rehabilitasi-stroke/aquatic-rehabilitation', [LayananController::class, 'aquaticRehabilitation'])->name('layanan.aquatic-rehabilitation');
