...
<section class="relative h-[600px] bg-gray-900 overflow-hidden">
    ...
    <img src="https://img.youtube.com/vi/bdCmDdKnJWg/maxresdefault.jpg" 
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {{-- Card 1: Academia --}}
            <div class="bg-white border border-gray-200 hover:shadow-xl transition-shadow duration-300" data-aos="fade-up" data-aos-delay="0">
            ...
            <div class="bg-white border border-gray-200 hover:shadow-xl transition-shadow duration-300" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="p-6">
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3">The First Robotic Therapy in Indonesia</h2>
            ...
            <div class="bg-white border border-gray-200 hover:shadow-xl transition-shadow duration-300" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="p-6">
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3">Advanced Technology Facilities</h2>
            ...
            <div class="bg-white border border-gray-200 hover:shadow-xl transition-shadow duration-300" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="p-6">
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-3">Senior Doctors</h2>
