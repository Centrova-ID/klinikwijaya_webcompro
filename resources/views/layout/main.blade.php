...
<head>
    ...
    <style>
        body {
            /* Menggunakan Nunito Sans sebagai font utama */
    ...
    {{-- CSS Style --}}
    @stack('styles')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/reg-symbol.css') }}">
</head>
<body class="bg-gray-50 overflow-x-hidden" data-turbo="true">
    {{-- Navbar --}}
    ...
    <script defer>
        ...
        marks.forEach(mark => {
          if (mark.textContent.trim() === 'R') {
            // Mengatur font-size menjadi 75% dari ukuran semula
            mark.style.fontSize = '0.75em'; 
            
            // Opsional: Menghilangkan padding agar background tidak terlalu lebar
    ...
    {{-- Script Link --}}
    @stack('scripts')
    <script src="{{ asset('js/reg-symbol.js') }}"></script>
</body>
</html>